...
class CameraPreview extends SurfaceView implements SurfaceHolder.Callback, Runnable 
{
    ...
    //public native int[] getLeftImage();
    //public native int[] getRightImage();
    public native void  getBitmap(int a, int b, int[] bb);
    public native void matBitmap(Bitmap bitmap1, Bitmap bitmap2);
